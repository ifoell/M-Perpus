...
if($lambat > 7) {
	echo "<script>alert('Buku yang dipinjam tidak dapat diperpanjang, karena sudah terlambat lebih dari 7 hari. Kembalikan terlebih dahulu, kemudian pinjam kembali !');</script>";
	...
	$next_7_hari	= mktime(0,0,0,$pecah[1],$pecah[2]+7,$pecah[0]);
